...
public class DropDown extends TestBase {
    ...
    public void trendyolDropdown() throws InterruptedException {
           ...
           List<WebElement> subheaderList= TestBase.driver.findElements(By.cssSelector("a.sub-category-header"));

       try{
            Actions action = new Actions(TestBase.driver);
            WebElement headerKadin = TestBase.driver.findElement(By.xpath("//a[@href='/butik/liste/1/kadin']"));
       ...
       //sub-item-list
       List<WebElement> subItemList= TestBase.driver.findElements(By.xpath("//ul[@class='sub-item-list']"));
